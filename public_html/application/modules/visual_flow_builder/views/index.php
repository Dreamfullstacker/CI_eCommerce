...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url(); ?>plugins/flow_builder/css/app.61627a45.css" rel="preload" as="style">
        <link href="<?php echo base_url(); ?>plugins/flow_builder/css/chunk-vendors.bff25d1a.css" rel="preload" as="style">
        <link href="<?php echo base_url(); ?>plugins/flow_builder/js/app.67dffdb0.js" rel="preload" as="script">
        ...
        <link href="<?php echo base_url(); ?>plugins/flow_builder/css/app.61627a45.css" rel="stylesheet">
    ...
    <body>
        ...
        <script src="<?php echo base_url(); ?>plugins/flow_builder/js/app.67dffdb0.js"></script>
