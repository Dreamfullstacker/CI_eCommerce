				...
				<div class="card main_card">
					...
					<div class="card-body">
						<form action="#" enctype="multipart/form-data" id="live_scheduler_form" method="post">
							...
							<div class="clearfix">
								<button class="btn btn-primary btn-lg" id="submit_post" name="submit_post" type="button"><i class="fa fa-edit"></i> <?php echo $this->lang->line("Edit Campaign"); ?> </button>
							</div>
...
<div class="modal fade" id="response_modal" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title"><i class="fa fa-flag"></i> <?php echo $this->lang->line("Live Campaign Status"); ?></h5>
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			</div>
			<div class="modal-body">
...
<div class="modal fade" id="modal-play"  data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><i class="fa fa-film"></i> <?php echo $this->lang->line("Image/Video Preview"); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
      </div>
      <div class="modal-body">
