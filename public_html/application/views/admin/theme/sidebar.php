    ...
    <ul class="sidebar-menu">
      <?php
        ...
        {          
            ...
            $color_css = $single_menu['url']!='social_accounts/index' ? "background: -webkit-linear-gradient(270deg,".$color998.",".adjustBrightness($color998,-0.65).");-webkit-background-clip: text;-webkit-text-fill-color: transparent;" : "color:".$color998;
            ...
            if(isset($menu_child_1_map[$single_menu['id']]) && count($menu_child_1_map[$single_menu['id']]) > 0)
            {
              ...
              {                  
                  ...
                  $menu_html .= "<li class='".$hide_second_menu."'><a {$child_newtab} {$second_menu_href} class='nav-link'><i style='color:".$color998."' class='".$single_child_menu['icon']."'></i>".$this->lang->line($single_child_menu['name'])."</a>";
