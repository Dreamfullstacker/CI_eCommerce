    ...
    if(isset($social_analytics_codes))
   	{
   		...
   		$first_menu = !empty($store_name_logo) ? '<a href="'.$store_link.'">'.$store_name_logo.'</a>' : '';
   	}

	?>
	  <div id="app">
	  	<?php if($show_header):?>
  		<div class="header w-100 py-3 bg-primary">
  		  <div class="container">		  
	  		  <ul class="list-unstyled">
	  		    <li class="media d-flex align-items-center">
	  		      <div class="mr-2 p-1 rounded-cirlce bg-primary"><?php echo $first_menu; ?></div>
              ...
              <span class="input-group-text text-muted"><span class="fa fa-search"></span></span>
	  		    </div>
	  		  </div>
	  		  <?php endif; ?>
  		  </div>  
