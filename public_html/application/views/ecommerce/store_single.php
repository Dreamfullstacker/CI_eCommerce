<section class="section my-3">
  ...
  <div class="section-body">
    <div class="category_container xscroll mb-2 py-2">
      <?php 
      $active_class = $url_cat=='' ? 'border bg-white' : 'border bg-white';
      echo '<div class="slide"><a class="pointer cat_nav nav-link" href="" data-val=""><img class="rounded-circle mx-auto mb-2 d-block '.$active_class.'" style="width:40px;height:40px;" src="'. base_url('assets/img/icon/shop.png').'"><span class="badge badge-primary">'.$this->lang->line("All Items").'</span></a></div>';
      unset($category_list['']);
      ...
      foreach ($category_list_raw as $key => $value)
      {
        ...
        $active_class2 = ($value['id']==$url_cat) ? 'border bg-white' : 'border bg-white';
        echo '<div class="slide text-center"><a class="pointer cat_nav nav-link" href="" data-val="'.$value['id'].'"><img class="rounded-circle mx-auto mb-2 d-block '.$active_class2.'" style="width:40px;height:40px;" src="'.$url.'"><span class="badge bg-white">'.$value["category_name"].'</span></a></div>';
      } ?>
    ...
    { ?>
      <div class="card shadow-none" id="nodata">
        <div class="card-body">
    ...
    <div class="row" id="product-container" style="margin-left: -3px;margin-right: -3px;">
        ...
        <div class="col-12 p-0">
          <div class="owl-carousel owl-theme" id="featured-products-carousel">
            <?php foreach($featured_product_lists as $featured) : ?>
              ...
              ?>
              <article class="article article-style-c mb-4" data-cat="<?php echo $featured['category_id'];?>">
                ...
                <div class="article-details p-2">
                  ...
                  <div class="article-category mb-1"><?php echo $display_featured_product_price; ?></div>
      ...
      foreach($product_list_grouped_ordered as $key_main => $value_main) :   
       ...
       foreach ($value_main as $key => $value) :         
          ...
          { ?>
            <div class="col-6 col-sm-6 col-md-6 col-lg-3 product-single" data-cat="<?php echo $value['category_id'];?>">
              <ul class="list-unstyled list-unstyled-border bg-white mb-3">
                  <li class="card shadow-none">
                     <a class="card-img-top-wrapper" href="<?php echo $product_link;?>">
                      <img width="110" height="110" class="card-img-top" src="<?php echo $imgSrc; ?>"/>
                     </a>
                    ...
                    <div class="card-body p-2">
                      ...
                      <h4 class="card-title mb-1">  
                        <a class="text-dark" href="<?php echo $product_link;?>">
                          <?php echo $value['product_name'];?>
                        </a>
                      </h4>

                      <p class="card-text mb-1 product-single-price"><?php echo $display_price;?></p>
                      
                      <p class="card-text mb-1 d-none">
                        <?php 
          ...
          { ?>
            <div class="col-6 col-sm-6 col-md-6 col-lg-4 product-single" data-cat="<?php echo $value['category_id'];?>">
    ...
    <div class="card shadow-none d-none w-100" id="nodata_search">
      <div class="card-body">
        <div class="empty-state">
          <img class="img-fluid" style="height: 200px" src="<?php echo base_url('assets/img/drawkit/drawkit-full-stack-man-colour.svg'); ?>" alt="image">
           <h2 class="mt-0"><?php echo $this->lang->line("We could not find any item.");?></h2>
